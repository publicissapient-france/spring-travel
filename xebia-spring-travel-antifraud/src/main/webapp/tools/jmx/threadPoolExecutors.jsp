...
<html>
<head>
<title>Thread Pool Executors</title>
</head>
<body>
        ...
        for (MBeanServer mbeanServer : mbeanServers) {
            ...
            out.println("<h2> MbeanServer domain = " + mbeanServer.getDefaultDomain() + "</h2>");
            {
                ...
                Set<ObjectInstance> objectInstances = mbeanServer.queryMBeans(new ObjectName(
                        "java.util.concurrent:type=ThreadPoolExecutor,*"), null);
                dumpMbeans(objectInstances, out, mbeanServer, "ActiveCount", "QueueRemainingCapacity", "RejectedExecutionCount",
                        "TaskCount");
            }
