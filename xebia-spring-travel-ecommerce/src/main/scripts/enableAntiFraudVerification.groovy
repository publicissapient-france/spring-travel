...
def cli = new CliBuilder( usage: 'groovy enableAntiFraudVerification [-h] -s servername -p port')
...
println("Enable Anti Fraud Verification on $jmxClient")
...
jmxClient.close()
println "Anti Fraud Verification successfully enabled. Bye"
